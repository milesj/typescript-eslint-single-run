...
import Product from '../measure/Product';

export default function Nodded() {
	const value = useEffect(() => {}, []);

	return <div><Warn /><Start /><Trunk /><Melted /><Magic /><Softly /><Which /><Past /><Young /><They /><Rate /><Refer /><Product /></div>;
}